...
class AmazingProductsModel extends AmazingProductsEntity{
  AmazingProductsModel({required super.id, required super.title, required super.price, required super.discount, required super.discountedPrice, required super.image});
